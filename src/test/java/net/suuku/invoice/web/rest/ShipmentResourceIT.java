...
import static net.suuku.invoice.domain.ShipmentAsserts.*;
...
import net.suuku.invoice.service.ShipmentService;
...
class ShipmentResourceIT {
    ...
    void createShipment() throws Exception {
        ...
        // Create the Shipment
        var returnedShipment = webTestClient
            .post()
            .uri(ENTITY_API_URL)
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(om.writeValueAsBytes(shipment))
            .exchange()
            .expectStatus()
            .isCreated()
    ...
    void putExistingShipment() throws Exception {
        ...
        webTestClient
            ...
            .contentType(MediaType.APPLICATION_JSON)
            .bodyValue(om.writeValueAsBytes(updatedShipment))
            .exchange()
            .expectStatus()
            .isOk();
