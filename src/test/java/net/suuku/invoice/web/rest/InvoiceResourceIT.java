package net.suuku.invoice.web.rest;

import static net.suuku.invoice.domain.InvoiceAsserts.*;
import static net.suuku.invoice.web.rest.TestUtil.createUpdateProxyForBean;
import static net.suuku.invoice.web.rest.TestUtil.sameNumber;
...
import net.suuku.invoice.IntegrationTest;
import net.suuku.invoice.domain.Invoice;
import net.suuku.invoice.domain.enumeration.InvoiceStatus;
import net.suuku.invoice.domain.enumeration.PaymentMethod;
import net.suuku.invoice.repository.EntityManager;
import net.suuku.invoice.repository.InvoiceRepository;
...
class InvoiceResourceIT {
    ...
    void partialUpdateInvoiceWithPatch() throws Exception {
        ...
        partialUpdatedInvoice.paymentMethod(UPDATED_PAYMENT_METHOD).paymentAmount(UPDATED_PAYMENT_AMOUNT);
