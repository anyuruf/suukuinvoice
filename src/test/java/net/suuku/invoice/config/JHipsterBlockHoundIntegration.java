...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("net.suuku.invoice.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("net.suuku.invoice.security.DomainUserDetailsService", "createSpringSecurityUser");
