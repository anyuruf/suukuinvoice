package net.suuku.invoice.domain;

import static net.suuku.invoice.domain.InvoiceTestSamples.*;
import static net.suuku.invoice.domain.ShipmentTestSamples.*;
import static org.assertj.core.api.Assertions.assertThat;

import java.util.HashSet;
import java.util.Set;
import net.suuku.invoice.web.rest.TestUtil;
